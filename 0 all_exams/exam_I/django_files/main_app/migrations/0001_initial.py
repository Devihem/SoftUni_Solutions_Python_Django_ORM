# Generated by Django 4.2.4 on 2023-11-23 20:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('Action', 'Action'), ('Comedy', 'Comedy'), ('Drama', 'Drama'), ('Other', 'Other')], default='Other', max_length=100, validators=[django.core.validators.MaxLengthValidator(6)])),
                ...
                ('starring_actor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='starring_actors', to='main_app.actor')),
            ],
        ),
    ]
