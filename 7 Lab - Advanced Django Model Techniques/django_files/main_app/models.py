...
# TASK 2 - "The menu must include each of the categories "Appetizers", "Main Course", "Desserts"."
def validate_description(text):
    if (("Main Course" not in text) or
            ("Appetizers" not in text) or
            ("Desserts" not in text)):
...
class RestaurantReview(ReviewMixin):
    ...
    class Meta(ReviewMixin.Meta):
        abstract = True  # For task 3 remove  needed for task 4
